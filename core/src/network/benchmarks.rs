#[cfg(test)]
mod tests {
    use crate::network::bandwidth::{SharedQosBandwidthLimiter, Priority};
    ...
    async fn benchmark_qos_latency_under_load() {
        ...
        let run_benchmark = |priority: Priority, name: &'static str, limiter: SharedQosBandwidthLimiter| async move {
            let iterations = 100;
